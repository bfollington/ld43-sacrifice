...
namespace Pixelplacement
{
	public class Client : NetworkDiscovery
	{
		...
		{
			Send((short)NetworkMsg.QuaternionMsg, new QuaternionMessage(value, id), qualityOfServiceChannel);
		}

		public static void Send(Quaternion[] value, string id = "", int qualityOfServiceChannel = 0)
		{
			Send((short)NetworkMsg.QuaternionArrayMsg, new QuaternionArrayMessage(value, id), qualityOfServiceChannel);
		}
